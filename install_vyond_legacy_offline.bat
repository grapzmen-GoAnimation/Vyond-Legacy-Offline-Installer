...
call Vyond-Legacy-Offline-Installer-main\Vyond-Legacy-Offline-Installer-main\PortableGit\bin\git.exe clone https://github.com/grapzmen-GoAnimation/Vyond-Legacy-Offline.git
) else (
echo You are running this installer as admin. so this will install just like how wrapper offline would come in.
call Vyond-Legacy-Offline-Installer-main\Vyond-Legacy-Offline-Installer-main\PortableGit\bin\git.exe clone --single-branch --branch admin https://github.com/grapzmen-GoAnimation/Vyond-Legacy-Offline.git
)
